---
title: "Civil cyber resilience is part of total defence"
description: "The day Sweden's payment and e-ID services go down for three hours, we feel how thin the digital layer is. Why governance, not technology, decides whether the country holds."
date: 2026-05-18
author: "Kim Borg"
category: "Total defence"
draft: false
image: /images/insights/civil-cyberresiliens-totalforsvar.webp
heroImage: /images/insights/hero-civil-cyberresiliens-totalforsvar.webp
tags: ["Total Defence", "Civil Preparedness", "Cyber Resilience", "NIS2", "Cybersecurity Act", "Governance", "Continuity", "Digital Sovereignty"]
---
...
Not what's nice to have. Not what's important according to the budget. But which systems the organisation can't manage without for three days, a week, a month. If the answer is ["we have a list somewhere"](/en/insights/your-vendor-register-isnt-a-crisis-plan), that isn't enough.
...
In the discussions about [NIS2 and the new Cybersecurity Act](/en/insights/nis2-cybersecurity-act), the word "burden" comes up often. That it means more documentation. More control. More administration.
...
Clarify [who owns information security](/en/insights/alone-with-the-responsibility) in your organisation. Not on paper. For real. With a mandate, a budget and reporting to top management. If that person doesn't exist, or if the role is split between three functions that never talk to each other, that's where the work begins.

Take stock of which services the organisation genuinely can't manage without. Classify them. Understand the dependencies back through the [supply chain](/en/insights/supply-chain-your-biggest-risk). Identify where the concentration risk is highest.

Build a systematic way of working. Not a project. A way of working. NIS2 and the Cybersecurity Act offer [a good structure](/en/insights/six-frameworks-one-governance-model) for that. Use them as tools, not as obstacles.
...
*If you want to discuss how your organisation can strengthen its civil cyber resilience, or how to move in practice from regulation to a way of working, [get in touch](/en/contact).*
